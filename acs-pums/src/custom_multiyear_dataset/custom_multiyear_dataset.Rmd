...
This tutorial will show you how to create a custom multi-year ACS PUMS dataset by appending multiple consecutive one-year datasets. We'll use several commands from the [`cbppstatautils` Stata package](https://github.com/CenterOnBudget/cbpp-stata-utils), so please install the package if you haven't already.
...
2. For each sampleyear in our multi-year sample:
