...
```{stata, echo=TRUE, message=FALSE, warning=FALSE}
sysuse auto, clear
describe
```

We can get a quick glimpse at the data by browsing them in the Data Editor or with the `browse` command:
